...
<body>
	...
	if(userID==null){ //정상적으로 글이 조회되지않았을경우
	...
	if(contentID==0){ //정상적으로 글이 조회되지않았을경우
		PrintWriter script =response.getWriter();
		script.println("<script>");
	...
	<div class="container">
		<div class="row">
			<form method="post" action="updateAction.jsp?contentID=<%=contentID%>">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control"
								value ="<%=ct.getTitle() %>" placeholder="글 제목" name="title" maxlength="50"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용"
									name="content" maxlength="2048" style="height: 350px;"><%=ct.getContent() %></textarea></td>
						</tr>
					</tbody>
				</table>
				<!-- 글쓰기 버튼 생성 -->

...
<body>
   ...
   Contents ct = new ContentsDao().getContents(contentID);
   ...
   <div class="container">
      <div class="row">
            ...
            <table class="table table-striped"
               ...
               <tbody>
                  <tr>
                   ...
                   <tr>
                      <td>작성일자</td>
                      <td colspan="2"><%=ct.getDate().substring(0,11) + ct.getDate().substring(11,13)+"시"+ ct.getDate().substring(14,16)+"분" %>
                     </td>
                 </tr>
                 <tr>
                    <td>내용</td>
                    <td colspan="2"style ="height: 200px;text-align: Left;">
                    <%= ct.getContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n","<br>") %>
                     </td>
                 </tr>
           ...
           %>
         <a href="update.jsp?contentID=<%= contentID %>" class= "btn btn-primary"> 수정</a>
         <a href="delete.jsp?contentID=<%= contentID %>" class= "btn btn-primary"> 삭제</a>
